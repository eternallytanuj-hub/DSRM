...
export default function OrbitalMap() {
  ...
  <header class="location-panel">
    ...
    <div style="display: flex; flex-direction: column; gap: 8px; margin-block-start: var(--space-4);">
      ...
      <a class="location-panel__about" id="marketplace-btn" href="/marketplace" style="margin-block-start: 0;">Marketplace <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
      <a class="location-panel__about" id="escrow-btn" href="/escrow-clearing" style="margin-block-start: 0;">Escrow & Wallet <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
      <a class="location-panel__about" id="telemetry-btn" href="/telemetry-oracle" style="margin-block-start: 0;">Telemetry Oracle <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
      <a class="location-panel__about" id="agent-btn" href="/api-smart-contract" style="margin-block-start: 0;">Agent API / Docs <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
    </div>
  </header>
