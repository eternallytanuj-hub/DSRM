...
export default function OrbitalMap() {
  ...
  <header class="location-panel">
    ...
    <div style="display: flex; flex-direction: column; gap: 18px; margin-block-start: 28px;">
      <a class="location-panel__about" id="about-btn" href="#about" role="button" style="margin-block-start: 0; font-size: 1.25rem; font-weight: 500; letter-spacing: -0.01em;">About this project <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
      <a class="location-panel__about" id="marketplace-btn" href="/marketplace" style="margin-block-start: 0; font-size: 1.25rem; font-weight: 500; letter-spacing: -0.01em;">Marketplace <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
      <a class="location-panel__about" id="escrow-btn" href="/escrow-clearing" style="margin-block-start: 0; font-size: 1.25rem; font-weight: 500; letter-spacing: -0.01em;">Escrow & Wallet <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
      <a class="location-panel__about" id="telemetry-btn" href="/telemetry-oracle" style="margin-block-start: 0; font-size: 1.25rem; font-weight: 500; letter-spacing: -0.01em;">Telemetry Oracle <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
      <a class="location-panel__about" id="agent-btn" href="/api-smart-contract" style="margin-block-start: 0; font-size: 1.25rem; font-weight: 500; letter-spacing: -0.01em;">Agent API / Docs <span class="location-panel__about-arrow" aria-hidden="true">&rarr;</span></a>
    </div>
  </header>
